    ...
    table.render({
      ...
      , url: 'sectionJCdata.json',
        ...
        cols: [[
          ...
          , { field: 'Year', align: 'center', width: 180, title: '年份' }
          , { field: 'BOD5', align: 'center', width: 160, title: '化学需氧量' }         
          , { field: 'ChemistryO', align: 'center', width: 140, title: '五日生化需氧量' }
          , { field: 'NH4N', align: 'center', width: 160, title: '氨氮' }
          , { field: 'N', align: 'center', width: 160, title: '总氮' }
          , { field: 'P', align: 'center', width: 160, title: '总磷' }
          , { field: 'DissolutionO', align: 'center', width: 160, title: '溶解氧' }
...
$(function () {
    ...
    $("#xinzeng").click(function () {
        ...
        , title: ""
        , area: ['620px', '300px']
        , content: '<div style="padding: 10px;"><span>断面名称:<input class="layui-input" /></span><span>断面编码:<input class="layui-input" /></span><span>氨氮:<input class="layui-input" /></span></div>'
        , btn: ['确定', '取消']
        , btnAlign: 'c' //按钮居中
        , shade: 0 //不显示遮罩
        , yes: function () {
    ...
    $("#xiugai").click(function () {
        ...
        , title: ""
        , area: ['620px', '300px']
        , content: '<div style="padding: 10px;"><span>断面名称:<input class="layui-input" value="万子湖" /></span><span>断面编码:<input class="layui-input" value="A110020"/></span><span>氨氮:<input class="layui-input" value="0.091"/></span></div>'
        , btn: ['确定', '取消']
        , btnAlign: 'c' //按钮居中
        , shade: 0 //不显示遮罩
        , yes: function () {
