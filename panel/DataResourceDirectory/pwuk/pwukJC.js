    ...
    table.render({
      ...
      , url: 'pwukJCdata.json',
        ...
        cols: [[
          ...
          , { field: 'monitortime', align: 'center', width: 160, title: '监测时间' }
          , { field: 'Emissions', align: 'center', width: 160, title: '污水排放流量(立方米/小时)' }
          , { field: 'BOD5', align: 'center', width: 160, title: '化学需氧量' }
          , { field: 'ChemistryO', align: 'center', width: 140, title: '五日生化需氧量' }
          , { field: 'NH4N', align: 'center', width: 140, title: '氨氮' }
          , { field: 'N', align: 'center', width: 140, title: '总氮' }
          , { field: 'P', align: 'center', width: 140, title: '总磷' },
